...
import { useGetContentType } from "../../../../Hooks/Users/content_type";

const EditContentTypeModal = ({ open, onClose, typeId }) => {
  ...
  const handleEdit = () => {
    ...
    navigate(`/dashboard/admin/edit/sub-categories/${typeId}`);
    onClose();
  };

  const handleDelete = () => {
    if (
      window.confirm(`Are you sure you want to delete "${typeData?.name}"?`)
    ) {
              ...
              >
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                  <Chip
                    ...
                    sx={{ fontWeight: 600 }}
                  />
                  {typeData?.total_services && (
                    <Chip
                      label={`${typeData?.total_services} Services`}
                      size="small"
                      sx={{
