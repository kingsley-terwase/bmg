...
} from "../../../Hooks/Dashboard/category_faq";
import { showToast } from "../../../utils/toast";
import { ConfirmDeleteModal } from "../../../Component";

const SingleCategoryFaqModal = ({ open, onClose, faqId }) => {
  const { faqData, getFaqData, loading: faqLoading } = useGetCategoryFaq();
  const { refetch } = useFetchCategoryFaqs();
  const [loading, setLoading] = useState(false);
  const [openDelete, setOpenDelete] = useState(false);
  const deletCategory = useDeleteCategoryFaq();
...
export default SingleCategoryFaqModal;
